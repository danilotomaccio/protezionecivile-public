...
/* harmony import */ var _store_modules_appState__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/store/modules/appState */ "./src/store/modules/appState.ts");
...
let Home = class Home extends vue_class_component__WEBPACK_IMPORTED_MODULE_5__.Vue {};
Home = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,vue_class_component__WEBPACK_IMPORTED_MODULE_5__.Options)({
  components: {
  ...
  mounted() {
    ...
    _store__WEBPACK_IMPORTED_MODULE_3__.store.dispatch(_store_modules_appState__WEBPACK_IMPORTED_MODULE_4__.LISTEN_CARS); // }
  },

  computed: {
    displayName() {
      return (0,vuex__WEBPACK_IMPORTED_MODULE_7__.useStore)(_store__WEBPACK_IMPORTED_MODULE_3__.key).state.firebase.user?.displayName;
    },

    usingCar: () => _store__WEBPACK_IMPORTED_MODULE_3__.store.state.appState.user.usingCar,
    ...
    headerString() {
      const usedCar = _store__WEBPACK_IMPORTED_MODULE_3__.store.getters.usedCar;

      if (usedCar) {
        return `Come va la ${usedCar.model}?`;
      }

      return `Ciao, ${this.displayName}!`;
    }

  },
  methods: {
    hasPermission(permission) {
      const user = _store__WEBPACK_IMPORTED_MODULE_3__.store.state.appState.user;
...
const _hoisted_9 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Sembra che tu non abbia alcun permesso. Non so perché tu abbia fatto il login ma per la protezione civile di Tricarico tu non hai diritti, non sei nessuno. L'unica cosa che potrai fare, non appena avrò messo il bottone per farlo, sarà il logout ");
...
(0,vue__WEBPACK_IMPORTED_MODULE_0__.createApp)(_App_vue__WEBPACK_IMPORTED_MODULE_1__["default"]).use(_store__WEBPACK_IMPORTED_MODULE_4__.store, _store__WEBPACK_IMPORTED_MODULE_4__.key).use(_router__WEBPACK_IMPORTED_MODULE_3__["default"]).mount('#app');
