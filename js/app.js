...
let Home = class Home extends vue_class_component__WEBPACK_IMPORTED_MODULE_4__.Vue {};
Home = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0,vue_class_component__WEBPACK_IMPORTED_MODULE_4__.Options)({
  components: {
  ...
  computed: {
    displayName() {
      return (0,vuex__WEBPACK_IMPORTED_MODULE_6__.useStore)(_store__WEBPACK_IMPORTED_MODULE_2__.key).state.firebase.user?.displayName;
    },

    usingCar: () => _store__WEBPACK_IMPORTED_MODULE_2__.store.state.appState.user.usingCar,
    ...
    headerString() {
      const usedCar = _store__WEBPACK_IMPORTED_MODULE_2__.store.getters.usedCar;
  ...
  methods: {
    hasPermission(permission) {
      const user = _store__WEBPACK_IMPORTED_MODULE_2__.store.state.appState.user;
